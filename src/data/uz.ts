...
export const uzCopy: SiteCopy = {
  ...
  report: {
    ...
    assessmentTitle: "Roʻyxatga olish imkoniyati bahosi",
    ...
    legendNeeds: "50–89",
    legendGood: "90–100",
    classChanceLabel: "Sinf boʻyicha ehtimol",
    metricLabel: "Metrika",
    scoreLabel: "Ball",
    weightLabel: "Vazn",
    contributionLabel: "Hissa",
    metricSim: "Nom oʻxshashligi",
    metricCls: "Nice kesishuvi",
    metricPhn: "Fonetika / yaqin variantlar",
    metricCnt: "Konflikt zichligi",
    metricSts: "Konflikt holati",
  },
  login: {
    title: "Kirish",
