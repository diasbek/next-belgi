...
export const ruCopy: SiteCopy = {
  ...
  report: {
    ...
    assessmentTitle: "Оценка возможности регистрации",
    ...
    legendNeeds: "50–89",
    legendGood: "90–100",
    classChanceLabel: "Шанс по классу",
    metricLabel: "Метрика",
    scoreLabel: "Балл",
    weightLabel: "Вес",
    contributionLabel: "Вклад",
    metricSim: "Сходство имени",
    metricCls: "Пересечение Nice",
    metricPhn: "Фонетика / близкие варианты",
    metricCnt: "Плотность конфликтов",
    metricSts: "Статус конфликтов",
  },
  login: {
    title: "Вход",
