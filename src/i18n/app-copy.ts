...
export const uzApp: AppCopy = {
  ...
  history: {
    ...
    lead: "Saqlangan tovar belgilari tahlili natijalari.",
    empty: "Tarix boʻsh.",
    query: "Tovar belgisi",
  ...
  profile: {
    ...
    linkGoogle: "Google akkauntini bogʻlash",
    unlinkGoogle: "Google bogʻlanishini uzish",
    googleUnlinked: "Google akkaunti uzildi",
  ...
  adminAttorneys: {
    ...
    count: "Jami",
    staticNote: "Statik katalog — saytdagi maʼlumotlar bilan bir xil.",
  },
  adminLedger: {
    title: "Kredit harakatlari",
    lead: "Barcha kredit jurnalidagi yozuvlar.",
    colDelta: "Delta",
    colBalance: "Balans",
    colReason: "Sabab",
    colDate: "Sana",
  ...
  adminIntegrations: {
    ...
    lead: "Tashqi modullar — kartochkalarda. Har birini alohida rejimda sozlang.",
    save: "Saqlash",
    test: "Test",
    saved: "Saqlandi",
    ...
    demoModeDisabled: "Demo rejim oʻchirilgan",
    ...
    modules: {
      eskiz: {
        ...
        steps: [
          ...
          "Rejim: Sinov (kod 00000) yoki Ishchi.",
          "Ishchi rejimda email, password, from ni toʻldiring → Saqlash → Test.",
        ],
      },
      resend: {
        title: "Email (Resend)",
        ...
        steps: [
          ...
          "Sinov yoki Ishchi → api_key / from → Saqlash → Test.",
        ],
      ...
      payme: {
        title: "Payme",
        lead: "Dev, sandbox yoki ishchi rejim.",
        steps: [
      ...
      click: {
        title: "Click",
        lead: "Dev yoki ishchi ekvayring.",
        steps: [
          "Dev — mock top-up.",
      ...
      google: {
        title: "Google",
        lead: "Kirish va akkauntni bogʻlash.",
        steps: [
      ...
      adliya: {
        ...
        steps: [
          ...
          "Rejim Ishchi → access_token (+ api_base) → Saqlash → Test.",
      ...
      ipaustralia: {
        title: "IP Australia",
        lead: "Avstraliya TM Search API. Mock, Test (UAT) yoki Live.",
        steps: [
          "portal.api.ipaustralia.gov.au da Australian Trade Mark Search API ga soʻrov qiling.",
          "Client credentials oling: Test va Live alohida (test_client_* / live_client_*).",
          "Rejim Test yoki Live → mos credentials → Saqlash → Test (OAuth + /search/quick).",
          "Tekshiruvda «Avstraliya» ni yoqing (+1 kredit).",
        ],
        portalUrl: "https://portal.api.ipaustralia.gov.au/",
        afterSave:
          "Token OK + search 403 = API ruxsati hali Approved emas. Docs: descriptions.api.gov.au/ipaustralia/trademark-search/iptms.html",
      },
      kazpatent: {
        title: "Kazpatent (KZ)",
  ...
  login: {
    ...
    switchToSignUp: "Akkauntingiz yoʻqmi? Roʻyxatdan oʻting",
    switchToSignIn: "Allaqachon akkauntingiz bormi? Kiring",
    acceptTerms:
    ...
    errors: {
      ...
      provider_taken: "Bu Google akkaunti boshqa foydalanuvchiga bogʻlangan",
      email_belongs_other: "Bu email boshqa akkauntga tegishli",
      google_email_required: "Google akkauntida tasdiqlangan email kerak",
      last_auth_method: "Oxirgi kirish usulini uzib boʻlmaydi",
      OTP_PEPPER_missing: "Server sozlamalari toʻliq emas",
    },
  },
  checkGate: {
    needLogin: "Belgini tekshirish uchun kiring",
...
export const ruApp: AppCopy = {
  ...
  adminIntegrations: {
    ...
    modules: {
      ...
      ipaustralia: {
        title: "IP Australia",
        lead: "Australian Trade Mark Search API. Mock, Test (UAT) или Live.",
        steps: [
          "Запросите доступ к Australian Trade Mark Search API на portal.api.ipaustralia.gov.au.",
          "Получите client credentials отдельно для Test и Live (test_client_* / live_client_*).",
          "Режим Test или Live → нужные credentials → Сохранить → Test (OAuth + /search/quick).",
          "В проверке включите «Австралия» (+1 кредит).",
        ],
        portalUrl: "https://portal.api.ipaustralia.gov.au/",
        afterSave:
          "Token OK + search 403 = доступ к API ещё не Approved. Docs: descriptions.api.gov.au/ipaustralia/trademark-search/iptms.html",
      },
      kazpatent: {
        title: "Kazpatent (KZ)",
...
export const enApp: AppCopy = {
  ...
  adminIntegrations: {
    ...
    modules: {
      ...
      ipaustralia: {
        title: "IP Australia",
        lead: "Australian Trade Mark Search API. Mock, Test (UAT), or Live.",
        steps: [
          "Request access to the Australian Trade Mark Search API at portal.api.ipaustralia.gov.au.",
          "Get client credentials separately for Test and Live (test_client_* / live_client_*).",
          "Mode Test or Live → matching credentials → Save → Test (OAuth + /search/quick).",
          "On check, enable “Australia” (+1 credit).",
        ],
        portalUrl: "https://portal.api.ipaustralia.gov.au/",
        afterSave:
          "Token OK + search 403 = API access not Approved yet. Docs: descriptions.api.gov.au/ipaustralia/trademark-search/iptms.html",
      },
      kazpatent: {
        title: "Kazpatent (KZ)",
